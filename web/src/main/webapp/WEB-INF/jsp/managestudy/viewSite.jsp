...
<c:choose>
  <c:when test="${fromListSite=='yes'}">
    <h1><span class="title_manage"><fmt:message key="view_site_details" bundle="${resworkflow}"/>: <c:out
        value="${siteToView.name}"/></span></h1>
  </c:when>
  <c:otherwise>
    <c:choose>
      <c:when test="${isAdminServlet == 'admin' && userBean.sysAdmin}">
...
<strong><fmt:message key="download_oid_in_odm_format_by_click" bundle="${restext}"/>
  <a href="DownloadStudyMetadata?studyId=<c:out value="${siteToView.id}"/>"> <fmt:message key="here"
                                                                                          bundle="${restext}"/></a>.</strong>
...
<div class="table_title_Manage"><a href="javascript:leftnavExpand('siteProperties');">
  <img id="excl_siteProperties" src="images/bt_Collapse.gif" border="0"> <fmt:message key="view_site_properties"
                ...
                <div class="box_BR">
                  ...
                  <div class="tablebox_center">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="parent_name" bundle="${resword}"/>:</td>
                        <td class="table_cell">
                      ...
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="sub_site" bundle="${resword}"/>:</td>
                        <td class="table_cell">
                      ...
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="unique_protocol_ID" bundle="${resword}"/>:
                        </td>
                        <td class="table_cell">
                      ...
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="secondary_IDs" bundle="${resword}"/>:</td>
                        <td class="table_cell">
                      ...
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="contract_number" bundle="${resword}"/>:</td>
                        <td class="table_cell">
                      ...
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="protocol_verification"
                                                                     bundle="${resword}"/>:
                        </td>
                        <td class="table_cell">
                      ...
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="estimated_completion_date"
                                                                     bundle="${resword}"/>:
                        </td>
                        <td class="table_cell">
                      ...
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="expected_total_enrollment"
                                                                     bundle="${resword}"/>:
                        </td>
                        <td class="table_cell">
                      ...
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="facility_name" bundle="${resword}"/>:</td>
                        <td class="table_cell">
                      ...
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="facility_address_1" bundle="${resword}"/>:
                        </td>
                        <td class="table_cell">
                      ...
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="facility_address_2" bundle="${resword}"/>:
                        </td>
                        <td class="table_cell">
                      ...
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="facility_address_3" bundle="${resword}"/>:
                        </td>
                        <td class="table_cell">
                      ...
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="facility_address_4" bundle="${resword}"/>:
                        </td>
                        <td class="table_cell">
                      ...
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="facility_city" bundle="${resword}"/>:</td>
                        <td class="table_cell">
                      ...
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="facility_state_province" bundle="${resword}"/>:</td>
                        <td class="table_cell">
                      ...
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="facility_ZIP" bundle="${resword}"/>:</td>
                        <td class="table_cell">
                      ...
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="facility_country" bundle="${resword}"/>:</td>
                        <td class="table_cell">
                      ...
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="consortium_name" bundle="${resword}"/>:</td>
                        <td class="table_cell">
                      ...
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="location_type" bundle="${resword}"/>:</td>
                        <td class="table_cell">
                      ...
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="active_label" bundle="${resword}"/>:</td>
                        <td class="table_cell">
                      ...
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="FWA_institution" bundle="${resword}"/>:</td>
                        <td class="table_cell">
                      ...
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="FWA_number" bundle="${resword}"/>:</td>
                        <td class="table_cell">
                      ...
                      <tr valign="top">
                        <td class="table_header_column"><fmt:message key="FWA_expiration_date" bundle="${resword}"/>:
                        </td>
                        <td class="table_cell">
                      ...
                      <c:forEach var="config" items="${siteToView.studyParameters}">
                        <c:choose>
                          ...
                          <c:when test="${config.parameter.handle=='interviewerNameRequired'}">
                            <tr valign="top">
                              <td class="table_header_column"><fmt:message key="when_entering_data"
                                                                           bundle="${resword}"/></td>
                              <td class="table_cell">
                                <c:choose>
                          ...
                          <c:when test="${config.parameter.handle=='interviewerNameDefault'}">
                            <tr valign="top">
                              <td class="table_header_column"><fmt:message key="interviewer_name_default_as_blank"
                                                                           bundle="${resword}"/></td>
                              <td class="table_cell">
                                <c:choose>
                          ...
                          <c:when test="${config.parameter.handle=='interviewDateRequired'}">
                            <tr valign="top">
                              <td class="table_header_column"><fmt:message key="interview_date_required"
                                                                           bundle="${resword}"/></td>
                              <td class="table_cell">
                                <c:choose>
                                  <c:when test="${  config.value.value == 'yes'}">
                          ...
                          <c:when test="${config.parameter.handle=='interviewDateDefault'}">
                            <tr valign="top">
                              <td class="table_header_column"><fmt:message key="interview_date_default_as_blank"
                                                                           bundle="${resword}"/></td>
                              <td class="table_cell">
                                <c:choose>
                                  <c:when test="${config.value.value== 'blank'}">
...
<div class="table_title_Manage" style="width:300px;float:left"><fmt:message key="view_site_event_definitions"
                                                                            bundle="${resword}"/></div>
...
<c:forEach var="definition" items="${definitions}">
  ...
  <img id="excl_sed<c:out value="${defCount}"/>" src="images/bt_Expand.gif" border="0"> <c:out
    value="${definition.name}"/></b></a>
  <c:choose>
                    ...
                    <div class="tablebox_center">
                      <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr valign="top">
                          ...
                          <td class="table_cell">
                            <c:choose>
                              <c:when test="${definition.repeating == true}"> <fmt:message key="yes"
                                                                                           bundle="${resword}"/>
                              </c:when>
                    ...
                    <div class="tablebox_center">
                      <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr valign="top">
                          ...
                          <td valign="top" class="table_header_row"><fmt:message key="required"
                                                                                 bundle="${resword}"/></td>
                          <td valign="top" class="table_header_row"><fmt:message key="double_data_entry"
                                                                                 bundle="${resword}"/></td>
                          <td valign="top" class="table_header_row"><fmt:message key="password_required"
                                                                                 bundle="${resword}"/></td>
                          <!-- <td valign="top" class="table_header_row"><fmt:message key="enforce_decision_conditions" bundle="${restext}"/></td>-->
                          <td valign="top" class="table_header_row"><fmt:message key="default_version"
                                                                                 bundle="${resword}"/></td>
                          <td valign="top" class="table_header_row"><fmt:message key="hidden_crf"
                                                                                 bundle="${resword}"/></td>
                          <c:choose>
                            <c:when test="${participateFormStatus == 'enabled'}">
                              <td valign="top" class="table_header_row"><fmt:message key="participant_form"
                                                                                     bundle="${resword}"/></td>
                              <td valign="top" class="table_header_row"><fmt:message key="allow_anonymous_submission"
                                                                                     bundle="${resword}"/></td>
                              <td valign="top" class="table_header_row"><fmt:message key="submission_url"
                                                                                     bundle="${resword}"/></td>
                              <td valign="top" class="table_header_row"><fmt:message key="offline"
                                                                                     bundle="${resword}"/></td>
                            </c:when>
                          </c:choose>

                          <td valign="top" class="table_header_row"><fmt:message key="null_values"
                                                                                 bundle="${resword}"/></td>
                          <td valign="top" class="table_header_row"><fmt:message key="selected_verions"
                                                                                 bundle="${resword}"/></td>
                          <td valign="top" class="table_header_row"><fmt:message key="sdv_option"
                                                                                 bundle="${resword}"/></td>
                          <td valign="top" class="table_header_row"><fmt:message key="status" bundle="${resword}"/></td>
                          <td valign="top" class="table_header_row"><fmt:message key="actions"
                                                                                 bundle="${resword}"/></td>
                        </tr>
                        ...
                        <c:forEach var="crf" items="${eventDefinitionCRFs}" varStatus="status">
                          ...
                          <tr valign="top">
                            ...
                            <td class="table_cell">
                              <c:choose>
                                <c:when test="${crf.requiredCRF == true}"> <fmt:message key="yes" bundle="${resword}"/>
                                </c:when>
                                <c:otherwise> <fmt:message key="no" bundle="${resword}"/> </c:otherwise>
                              </c:choose>
                            </td>
                            ...
                            <td class="table_cell">
                              <c:choose>
                                <c:when test="${crf.doubleEntry == true}"> <fmt:message key="yes" bundle="${resword}"/>
                                </c:when>
                                <c:otherwise> <fmt:message key="no" bundle="${resword}"/> </c:otherwise>
                              </c:choose>
                            </td>
                            ...
                            <td class="table_cell">
                              <c:choose>
                                <c:when test="${crf.electronicSignature == true}"> <fmt:message key="yes"
                                                                                                bundle="${resword}"/>
                                </c:when>
                                <c:otherwise> <fmt:message key="no" bundle="${resword}"/> </c:otherwise>
                              </c:choose>
                            ...
                            <c:choose>
                              <c:when test="${participateFormStatus == 'enabled'}">
                                <td class="table_cell">
                                  <c:choose>
                                    <c:when test="${crf.participantForm == true}"> <fmt:message key="yes"
                                                                                                bundle="${resword}"/>
                                    </c:when>
                                    <c:otherwise> <fmt:message key="no" bundle="${resword}"/> </c:otherwise>
                                  </c:choose>
                                ...
                                <td class="table_cell">
                                  <c:choose>
                                    <c:when test="${crf.allowAnonymousSubmission == true}"> <fmt:message key="yes"
                                                                                                         bundle="${resword}"/>
                                    </c:when>
                                    <c:otherwise> <fmt:message key="no" bundle="${resword}"/> </c:otherwise>
                                  </c:choose>
                            ...
                            <td class="table_cell"><fmt:message key="${crf.sourceDataVerification.description}"
                                                                bundle="${resterm}"/></td>
...
<c:choose>
  <c:when test="${userBean.sysAdmin}">
    <input type="button" onclick="confirmExit('ListSite');" name="cancel"
           value="<fmt:message key="exit" bundle="${resword}"/>   " class="button_medium"/>
  </c:when>
  <c:otherwise>
    <input type="button" onclick="goBack();" name="cancel" value="<fmt:message key="exit" bundle="${resword}"/>   "
           class="button_medium"/>
  </c:otherwise>
</c:choose>
