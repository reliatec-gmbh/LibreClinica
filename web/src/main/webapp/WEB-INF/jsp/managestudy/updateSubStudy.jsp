...
<fmt:message key="update_site_details" bundle="${resword}"/>: <c:out value="${newStudy.name}"/></span></h1><br><br>
...
<form action="UpdateSubStudy" method="post">
  ...
  <div class="table_title_Manage"><a href="javascript:leftnavExpand('siteProperties');">
    <img id="excl_siteProperties" src="images/bt_Collapse.gif" border="0"> <fmt:message key="update_site_properties"
