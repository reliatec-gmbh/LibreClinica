...
<p class="aka_para"><fmt:message key="can_download_blank_CRF_ods" bundle="${restext}"/><a href="DownloadVersionSpreadSheet?template=1"><b><fmt:message key="here" bundle="${resword}"/></b></a>.</p>
