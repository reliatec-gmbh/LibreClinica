...
public class SQLInitServlet extends HttpServlet {
	...
	public void init() throws ServletException {
		...
		// 'passwd_expiration_time' and 'change_passwd_required' are now defined in the
		// database
	...
	/**
	 * We return empty String if DBName is not found in params. The only reason why
	 * this is done this way is for unit testing to work properly.
	 *
	...
	/**
	 * Overrides a configuration in a properties file with a value read from the
	 * database.
	 * 
	 ...
	 */
	private void overridePropertyFromDatabase(ConfigurationDao configurationDao, String propertyNameInDatabase, Properties properties,
			String propertyNameInProperties) {
