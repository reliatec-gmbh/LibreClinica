...
public class ProtocolDeviationFilter implements CriteriaCommand {
    List<ProtocolDeviationFilter.Filter> filters = new ArrayList<>();
    HashMap<String, String> columnMapping = new HashMap<String, String>();
    @Override
    public String execute(String criteria) {
        String theCriteria = "";
        for (ProtocolDeviationFilter.Filter filter : filters) {
