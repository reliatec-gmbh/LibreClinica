...
# T009-06: create a new site (mail notification enabled in parent study)
**description:**  
This test focuses on creating a new site, with only the basic, required properties.
...
**expected results:**
A message will appear **The new Site has been created successfully.** Mail notifications should be enabled.

# T009-06: create a new site (mail notification disabled in parent study)
**description:**  
This test focuses on creating a new site, with only the basic, required properties.
...
**expected results:**
A message will appear **The new Site has been created successfully.** Mail notifications should be disabled.

# T009-07: edit a site (mail notification enabled in parent study)
**description:**  
This test focuses on editing the properties of a site. 
...
**expected results:**  
The message **The study has been updated successfully.** (**check A**) should appear, and the edits are displayed correctly. Mail notifications should be enabled.

# T009-07: edit a site (mail notification disabled in parent study)
**description:**  
This test focuses on editing the properties of a site. 
...
**expected results:**  
The message **The study has been updated successfully.** (**check A**) should appear, and the edits are displayed correctly. Mail notifications should be disabled.