...
## T003-09: Activate user's 2-factor authentication settings
**description:**  
This test focuses on availability of 2-factor authentication configuration capabilities within the user's profil settings.
